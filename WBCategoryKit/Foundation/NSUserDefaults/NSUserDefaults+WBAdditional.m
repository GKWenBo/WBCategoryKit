...
+ (void)wb_saveIntegerValue:(NSInteger)integerValue
                     forKey:(NSString *)key {
    [[NSUserDefaults standardUserDefaults] setInteger:integerValue
                                               forKey:key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (void)wb_saveFloatValue:(float)floatValue
                   forKey:(NSString *)key {
    [[NSUserDefaults standardUserDefaults] setFloat:floatValue
                                             forKey:key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (void)wb_saveDoubleValue:(double)doubleValue
                    forKey:(NSString *)key {
    [[NSUserDefaults standardUserDefaults] setDouble:doubleValue
                                              forKey:key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (void)wb_saveBoolValue:(BOOL)boolValue
                  forKey:(NSString *)key {
    [[NSUserDefaults standardUserDefaults] setBool:boolValue
                                            forKey:key];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (void)wb_saveLonglongValue:(int64_t)longlongValue
                      forKey:(NSString *)key {
    [self wb_saveObject:[NSNumber numberWithLongLong:longlongValue]
                 forKey:key];
}
