...
+ (UIColor *)wb_skyBlueColor {
    return [UIColor wb_rgbColorWithRed:135.f
                                 green:206.f
                                  blue:235.f];
}
...
+ (UIColor *)wb_goldenYellowColor {
    return [UIColor wb_rgbColorWithRed:255.f
                                 green:215.f
                                  blue:0.f];
}
...
+ (UIColor *)wb_chocolateColor {
    return [UIColor wb_rgbColorWithRed:210.f
                                 green:105.f
                                  blue:30.f];
}
...
+ (UIColor *)wb_IndiaRedColor {
    return [UIColor wb_rgbColorWithRed:176.f
                                 green:23.f
                                  blue:31.f];
}
...
+ (UIColor *)wb_peacockBlueColor {
    return [UIColor wb_rgbColorWithRed:51.f
                                 green:161.f
                                  blue:201.f];
}
...
+ (UIColor *)wb_violetColor {
    return [UIColor wb_rgbColorWithRed:138.f
                                 green:43.f
                                  blue:226.f];
}
...
+ (UIColor *)wb_tawnyColor {
    return [UIColor wb_rgbColorWithRed:240.f
                                 green:230.f
                                  blue:140.f];
}
...
+ (UIColor *)wb_jasmineColor {
    return [UIColor wb_rgbColorWithRed:245.f
                                 green:222.f
                                  blue:179.f];
}
...
+ (UIColor *)wb_eggShellColor {
    return [UIColor wb_rgbColorWithRed:252.f
                                 green:230.f
                                  blue:201.f];
}
