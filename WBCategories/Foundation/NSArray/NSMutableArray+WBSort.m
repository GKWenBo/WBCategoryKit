...
#import "NSMutableArray+WBSort.h"

@implementation NSMutableArray (WBSort)
/**
...
- (void)wb_quickSortWithLowIndex:(NSInteger)low highIndex:(NSInteger)high{
    ...
    [self wb_quickSortWithLowIndex:low highIndex:baseIndex - 1];
    [self wb_quickSortWithLowIndex:baseIndex + 1 highIndex:high];
}
