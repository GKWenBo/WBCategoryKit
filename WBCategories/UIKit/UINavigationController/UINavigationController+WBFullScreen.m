//
//  UINavigationController+WBFullScreen.m
...
#import "UINavigationController+WBFullScreen.h"
#import "NSObject+WBRuntime.h"

@implementation UIViewController (WBFullScreen)
...
@implementation UINavigationController (WBFullScreen)
+ (void)load {
