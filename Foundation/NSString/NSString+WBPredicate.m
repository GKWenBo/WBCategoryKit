...
+ (BOOL)wb_isNull:(NSString *)object
{
    ...
    if ([object isEqual:[NSNull null]]) {
        ...
        object = object.wb_trim;
        if (object != nil && object.length > 0 && ![object isEqualToString:@"null"]&&![object isEqualToString:@"(null)"]&&![object isEqualToString:@" "]) {
            return  NO;
        }
        return YES;
    }
