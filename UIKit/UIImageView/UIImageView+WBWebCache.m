...
- (void)wb_setImageWithFadeAnimation:(NSString *)url
    ...
    [self sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:placeholder] completed:^(UIImage * _Nullable image, NSError * _Nullable error, SDImageCacheType cacheType, NSURL * _Nullable imageURL) {
...
- (void)wb_setImageWithURL:(NSString *)url
          placeholderImage:(NSString *)placeholder
                 ...
                 completed:(SDExternalCompletionBlock)completedBlock {
    [self sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:placeholder] options:options completed:completedBlock];
}
